...
export default function WorksBar() {
  ...
  const words = "VISUALLY DRIVEN AND COLLABORATIVELY BUILT.".split(" ");
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-4">
          ...
          <div className="col-span-12 sm:col-span-8 lg:col-span-9 mt-6 sm:mt-0 overflow-hidden">
            <motion.h1
              initial="hidden"
              whileInView="visible"
              viewport={{ once: false, amount: 0.4 }} // 👈 muncul setiap masuk section
              variants={{
                hidden: { opacity: 1 },
                visible: {
                  opacity: 1,
                ...
                >
                  {word.split("").map((char, ci) => (
                    <motion.span
                      ...
                      viewport={{ once: false }} // 👈 reset animasi tiap masuk view
                      transition={{
